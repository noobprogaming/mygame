<?php
	...
	if(!empty($gresult->fetch_assoc())){
		...
		$gsql2 = "INSERT INTO user(id,name,email,pp,joined) VALUES ('".$_POST["id"]."', '".$_POST["name"]."', '".$_POST["email"]."', '".$_POST["pp"]."',now())";
		$gsql3 = "INSERT INTO rig VALUES ('".$_POST["id"]."','1','1','1','1','1','1','1','1')";
		$koneksi->query($gsql3);
	}

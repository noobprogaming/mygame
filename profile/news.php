                    ...
                    <div class="col-lg-8 my-3">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                </p><span class="text-muted">Baca Selanjutnya</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8 my-3">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                menguntungkan.</p><span class="text-muted">Baca Selanjutnya</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8 my-3">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                genre apapun yang mereka usung. </p><span class="text-muted">Baca Selanjutnya</span>
                            </div>
                        </div>
                    </div>

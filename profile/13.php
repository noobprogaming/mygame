                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-12" style ="text-align: justify; text-justify: inter-word;">
                                ...
                                <img style="width: 100%"src="../assets/img/photo/fp1.jpg"
                                        class="img-fluid" /><br>
                                    ...
                                    <img style="width: 100%"src="../assets/img/photo/fp2.jpg"
                                        class="img-fluid" /><br>
                                    ...
                                    <img style="width: 100%"src="../assets/img/photo/fp3.jpg" class="img-fluid"/>><br>
